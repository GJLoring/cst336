...
INSERT INTO `superhero` (`id`, `name`, `firstName`, `lastName`, `pob`, `image`) VALUES
(1, 'Spiderman', 'Peter', 'Parker', 'New York', 'spiderman'),
...
INSERT INTO `villain` (`villainId`, `villainName`, `villainImage`, `superheroId`) VALUES
(1, 'Dr. Octopus', ' http://www.marveldirectory.com/pictures/individuals/d_1d/droctopus.jpg', 1),
